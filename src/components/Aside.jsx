...
const Aside = () => {
  ...
  return (
    <aside id="application-sidebar-brand"
            class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transform hidden xl:block xl:translate-x-0 xl:end-auto xl:bottom-0 fixed top-0 left-0 h-screen z-[999] flex-col w-[270px] !border-r border-gray-400 bg-white transition-all duration-300"
